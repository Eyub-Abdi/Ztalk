...
import { API_BASE, defaultHeaders } from "./useAuthApi";
        ...
        >
          ...
          <div className="px-6 py-4 overflow-y-auto max-h-[calc(90vh-80px)]">
            ...
            <div className="flex justify-between mb-6 border-b border-gray-200">
              <button
                className={clsx(
                  "px-4 py-3 text-sm font-medium transition-all duration-300 ease-in-out relative",
                  view === "login"
                    ? "text-blue-600"
              ...
              >
                Login
                {view === "login" && (
                  <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-600 transition-all duration-300 ease-in-out"></div>
                )}
              </button>
              <button
                className={clsx(
            ...
            {view === "login" ? (
              <div className="flex flex-col gap-6 transition-all duration-300 ease-in-out animate-in fade-in-0">
                {!showForgotPassword ? (
                  <>
                    {/* Login form */}
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-xs text-gray-500 text-center mt-3">
                        We never post to any account. You&#39;ll choose a
