...
function useSimpleToast() {
  return {
    show: (title: string, type: "success" | "error" | "info" = "info") => {
      // For now, just use alert - you can replace with a proper toast library
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="flex-1 flex flex-col items-center text-center gap-4">
                ...
                <p className="text-xs text-gray-500 max-w-[260px]">
                  We never post to any account. You&#39;ll choose a password later
                  if needed.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-6">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 space-y-2">
                            ...
                            <div className="flex gap-2 pt-1">
                              <button
                                onClick={() =>
                                  toast.show("Verification link resent", "success")
                                }
                ...
                {signupStep === 2 && (
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div>
                        <label htmlFor="reg-user-type" className="block text-sm font-medium text-gray-700 mb-1">
                      ...
                      <div>
                        <label htmlFor="reg-language" className="block text-sm font-medium text-gray-700 mb-1">
                          Preferred Language
                        </label>
                        <select
                          id="reg-language"
