  ...
  const handleSubmit = () => {
    ...
    if (!form.teacher_bio.trim() || form.teacher_bio.trim().length < 50) {
      toast.show({
        ...
        description: "Please write at least 50 characters describing yourself as a teacher",
        status: "error",
      });
      return;
    }
        ...
        <div className="space-y-4">
          ...
          <div>
            <label
              ...
              className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5"
            >
              Describe yourself as a teacher <span className="text-red-500">*</span>
            </label>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
              Write a compelling bio that helps students understand your teaching approach and personality (minimum 50 characters)
            </p>
            <textarea
              id="teacher-bio"
              placeholder="Tell students about your teaching style, what makes you unique, and how you help students achieve their goals..."
              ...
              className={clsx(
                ...
                form.teacher_bio.trim().length > 0 && form.teacher_bio.trim().length < 50
            ...
            <div className="flex justify-between items-center mt-1">
              ...
              >
                {form.teacher_bio.trim().length < 50
                  ? `${50 - form.teacher_bio.trim().length} more characters needed`
                  : "✓ Bio looks good!"}
              </span>
