  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 px-6 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Upcoming */}
        <div className="bg-white rounded-xl p-5 border border-gray-100 transition-all hover:border-gray-200">
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2.5 bg-brand-50 rounded-lg text-brand-500">
