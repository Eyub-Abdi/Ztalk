...
export default function Bookings() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 px-6 py-8">
      {/* Next lesson card */}
      <div className="bg-gradient-to-br from-white via-gray-50/30 to-brand-50/20 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-5 border border-gray-200/60 dark:border-gray-700/50 shadow-lg shadow-brand-500/5 backdrop-blur-sm">
