        ...
        <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      {completionMetrics.completed} of {completionMetrics.total} done
                    </p>
                  </div>
                </div>
                  ...
                  {checklist.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className={clsx(
                          "text-sm font-medium",
                          item.completed ? "text-gray-500 line-through" : "text-gray-900 dark:text-gray-100"
                        )}>
                          {item.label}
                        </p>
                      </div>
          ...
          <div className="bg-gradient-to-br from-white via-gray-50/30 to-brand-50/10 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 border border-gray-200/60 dark:border-gray-700/50 shadow-lg shadow-gray-900/5">
            <div className="space-y-8">
              {/* Avatar section */}
              <div id="avatar-section" className="flex items-center gap-5 pb-8 border-b border-gray-200/60 dark:border-gray-700/60 transition-all duration-300 rounded-xl">
            ...
            <div id="bio-section" className="transition-all duration-300 rounded-xl">
              <label
                htmlFor="profile-bio"
                className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2.5"
              >
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <button className="px-5 py-3 text-sm font-semibold text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 hover:shadow-md transition-all">
                  Change Password
                </button>
                <button className="px-5 py-3 text-sm font-semibold text-red-600 dark:text-red-400 bg-white dark:bg-gray-800 border-2 border-red-200 dark:border-red-800 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 hover:border-red-400 hover:shadow-md transition-all">
                  Delete Account
                </button>
              </div>
            </div>
