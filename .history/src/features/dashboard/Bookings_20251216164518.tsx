        ...
        <div className="group relative bg-gradient-to-br from-white via-gray-50/30 to-brand-50/10 rounded-2xl p-6 border border-gray-200 hover:border-brand-300 hover:shadow-xl hover:shadow-brand-500/10 hover:-translate-y-1 transition-all duration-300">
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center justify-between mb-1">
              ...
              <div className="p-1.5 bg-gradient-to-br from-brand-500/10 to-brand-600/5 rounded-lg opacity-60 group-hover:opacity-100 transition-opacity">
                <FiEdit3 className="w-3 h-3 text-brand-600" />
              </div>
            </div>
            <span className="text-3xl font-bold bg-gradient-to-br from-brand-600 via-brand-500 to-indigo-600 bg-clip-text text-transparent">
              {stats.attention}
        ...
        <div className="group relative bg-gradient-to-br from-white via-gray-50/30 to-brand-50/10 rounded-2xl p-6 border border-gray-200 hover:border-brand-300 hover:shadow-xl hover:shadow-brand-500/10 hover:-translate-y-1 transition-all duration-300">
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center justify-between mb-1">
              ...
              <div className="p-1.5 bg-gradient-to-br from-brand-500/10 to-brand-600/5 rounded-lg opacity-60 group-hover:opacity-100 transition-opacity">
                <FiCheckCircle className="w-3 h-3 text-brand-600" />
              </div>
            </div>
            <span className="text-3xl font-bold bg-gradient-to-br from-brand-600 via-brand-500 to-indigo-600 bg-clip-text text-transparent">
      ...
      <div className="space-y-4">
        ...
        {!isLoading && filteredBookings.length === 0 && (
          <div className="bg-white rounded-2xl p-12 border border-gray-200 text-center">
            ...
            <p className="font-semibold text-gray-900 mb-1">No bookings to show</p>
        ...
        {!isLoading &&
          filteredBookings.map((booking) => {
            ...
            return (
              <div
                key={booking.id}
                className="group bg-white rounded-2xl p-5 border border-gray-200 hover:border-brand-300 hover:shadow-lg hover:shadow-brand-500/5 transition-all duration-200"
              >
                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                  {/* Student info */}
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    <div className="p-2.5 bg-gradient-to-br from-brand-500 to-indigo-600 rounded-xl shadow-md shadow-brand-500/20">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-500">{booking.lesson_type}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 sm:gap-6">
                    ...
                    <span
                      className={clsx(
                        "px-3 py-1.5 text-xs rounded-lg font-semibold whitespace-nowrap",
                        colors.bg,
                        colors.text
                      )}
                    >
                ...
                <div className="flex items-center gap-2 mt-4 pt-4 border-t border-gray-100">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-xs font-semibold transition-all flex items-center gap-1.5 bg-green-500 text-white hover:bg-green-600 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isStarting ? (
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-xs font-semibold transition-all flex items-center gap-1.5 bg-brand-500 text-white hover:bg-brand-600 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isCompleting ? (
                      <span className="w-3 h-3 border-2 border-white border-t-transparent rounded-full animate-spin" />
                    ) : (
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-xs font-semibold transition-all flex items-center gap-1.5 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300"
                  >
