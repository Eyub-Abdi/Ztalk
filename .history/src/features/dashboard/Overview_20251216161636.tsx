...
function QuickAction({
  ...
  const colorClasses = {
    brand: "from-brand-500 to-indigo-600 shadow-brand-500/30 hover:shadow-brand-500/40",
    green: "from-green-500 to-emerald-600 shadow-green-500/30 hover:shadow-green-500/40",
    purple: "from-purple-500 to-pink-600 shadow-purple-500/30 hover:shadow-purple-500/40",
    orange: "from-orange-500 to-amber-600 shadow-orange-500/30 hover:shadow-orange-500/40",
  };
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-white via-blue-50/20 to-indigo-50/30 rounded-2xl p-8 border border-blue-200/30 shadow-lg shadow-blue-900/5 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-300">
          <div className="relative z-10 space-y-6">
            ...
            {data && data.upcoming_lessons > 0 && (
              <div className="mt-4 p-4 bg-white/70 rounded-xl border border-blue-100/50">
          ...
          <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-500/10 to-transparent rounded-2xl -mr-16 -mt-16" />
        </div>
