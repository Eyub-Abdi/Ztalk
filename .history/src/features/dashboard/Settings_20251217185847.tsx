...
import { FiSave, FiCheckCircle, FiCircle, FiLock, FiAlertTriangle, FiX, FiEye, FiEyeOff } from "react-icons/fi";
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                    Language cannot be changed after initial setup. Contact support if you need to update it.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="p-5 bg-red-50/50 dark:bg-red-900/10 rounded-xl border-2 border-red-200 dark:border-red-800">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Permanently delete your account and all associated data. This action cannot be undone.</p>
                  </div>
                  <button
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                Type your email to confirm: <span className="text-red-500">{profile.email || "your@email.com"}</span>
              </label>
              <input
                type="email"
