  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <aside
          className={clsx(
            "w-[300px] bg-gray-50 flex-shrink-0 fixed top-[89px] left-0 h-[calc(100vh-89px)] z-30 transition-transform duration-300 ease-in-out",
        ...
        <div
          className={clsx(
            ...
            !isMobile && sidebarVisible ? "w-[300px]" : "w-0"
          )}
        />
        ...
        <main className="flex-1 px-6 lg:px-10 py-2 lg:py-3 min-h-[calc(100vh-89px)] transition-all duration-300 ease-in-out">
          {/* Enhanced floating sidebar toggle when hidden */}
          {!isMobile && !sidebarVisible && (
            <button
              onClick={() => setSidebarVisible(true)}
              className="fixed top-32 left-6 z-50 group p-4 bg-gradient-to-r from-brand-500 to-brand-600 text-white rounded-2xl shadow-lg hover:shadow-xl hover:shadow-brand-500/25 hover:scale-105 transition-all duration-300 animate-fade-in"
              aria-label="Show sidebar"
            >
              <FiSidebar className="w-5 h-5 group-hover:scale-110 transition-transform duration-200" />
