...
function NavItem({
  ...
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        clsx(
          "flex items-center rounded-xl transition-all duration-200 min-h-[48px] group",
      ...
      <div className="flex">
        ...
        <aside
          className={clsx(
            ...
            isMobile ? "-translate-x-full" : sidebarVisible ? "w-[300px] translate-x-0" : "w-[60px] translate-x-0"
          )}
        >
        >
          <div className={clsx("transition-all duration-300 ease-in-out", sidebarVisible ? "p-6" : "p-3")}>
            <SidebarContent
        ...
        <div
          className={clsx(
            ...
            isMobile ? "w-0" : sidebarVisible ? "w-[300px]" : "w-[60px]"
          )}
        />
