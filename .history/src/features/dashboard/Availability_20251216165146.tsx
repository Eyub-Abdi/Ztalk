...
import { FiRefreshCw, FiTrash2, FiClock, FiCalendar, FiCheck } from "react-icons/fi";
    ...
    <div className="max-w-7xl mx-auto space-y-6 px-6 py-8">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <button
          ...
          className="px-4 py-2 rounded-lg text-sm font-semibold transition-all flex items-center gap-2 bg-gradient-to-r from-brand-500 to-brand-600 text-white shadow-md shadow-brand-500/20 hover:shadow-lg hover:shadow-brand-500/30 hover:-translate-y-0.5"
        >
        ...
        <button
          onClick={clearAll}
          className="px-4 py-2 rounded-lg text-sm font-semibold transition-all flex items-center gap-2 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-red-300 hover:text-red-600"
        >
      ...
      <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm">
        <style>{`
          ...
          .fc-button {
            background: linear-gradient(to right, ${brandColor}, #4f46e5) !important;
