  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 px-6 py-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-100 min-w-[280px]">
          <p className="text-xs text-gray-500 font-medium mb-1">Next lesson</p>
          <p className="text-sm font-semibold text-gray-900">{nextLessonText}</p>
          <p className="text-xs text-gray-500 mt-1">{nextLessonRelative}</p>
        </div>
      </div>
