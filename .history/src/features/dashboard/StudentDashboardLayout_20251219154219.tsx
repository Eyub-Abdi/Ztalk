    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <main className="flex-1 px-6 lg:px-10 py-2 lg:py-3 min-h-[calc(100vh-89px)] transition-all duration-300 ease-in-out">
          {/* Simple floating sidebar toggle when hidden */}
          {!isMobile && !sidebarVisible && (
            <button
              onClick={() => setSidebarVisible(true)}
              className="fixed top-24 left-0 z-50 p-2 bg-white border-r border-t border-b border-gray-200 rounded-r-lg shadow-md hover:shadow-lg hover:bg-gray-50 transition-all duration-200"
              aria-label="Show sidebar"
            >
              <FiSidebar className="w-4 h-4 text-gray-700" />
            </button>
          )}
          <Outlet />
        </main>
