        ...
        <div className="space-y-6 py-6">
          <div className="card p-6">
            <div className="space-y-6">
              ...
              {/* Form fields */}
              <div>
                <label htmlFor="profile-fullname" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                  Full Name
                </label>
                <input
                  id="profile-fullname"
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="profile-timezone" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                      Timezone
                    </label>
                    <select
                      id="profile-timezone"
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p id="notif-email-label" className="text-sm font-medium text-gray-900 dark:text-white">
                        Email Notifications
                      </p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p id="notif-sms-label" className="text-sm font-medium text-gray-900 dark:text-white">
                        SMS Notifications
                      </p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p id="notif-marketing-label" className="text-sm font-medium text-gray-900 dark:text-white">
                        Marketing Emails
                      </p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">
