            ...
            <div className="relative h-48">
              ...
              <div className="mr-10 h-full relative">
                ...
                >
                  ...
                  {/* Yellow area fill */}
                  <path
                    d="M0,120 Q30,80 60,90 T120,60 T180,100 T240,40 T300,80 T360,50 T400,70 L400,150 L0,150 Z"
                    fill="url(#yellowGradient)"
                  />

                  {/* Yellow line */}
                  <path
                    d="M0,120 Q30,80 60,90 T120,60 T180,100 T240,40 T300,80 T360,50 T400,70"
                    fill="none"
                    stroke="#f59e0b"
                    strokeWidth="2.5"
                  />
                  ...
                  {/* Red area fill */}
                  <path
                    d="M0,140 Q50,135 100,130 T200,125 T300,140 T350,120 T400,130 L400,150 L0,150 Z"
                    fill="url(#redGradient)"
                  />

                  {/* Red line */}
                  <path
                    d="M0,140 Q50,135 100,130 T200,125 T300,140 T350,120 T400,130"
                    fill="none"
                    stroke="#ef4444"
                    strokeWidth="2"
                  />
