...
export default function Settings() {
  ...
  const videoPreviewUrl = useMemo(() => {
    if (teachingProfile.videoFile) {
      return URL.createObjectURL(teachingProfile.videoFile);
    }
    return teachingProfile.videoUrl || null;
  }, [teachingProfile.videoFile, teachingProfile.videoUrl]);

  // Teaching specialties options
          ...
          <div className="bg-gradient-to-br from-white via-gray-50/30 to-brand-50/10 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 border border-gray-200/60 dark:border-gray-700/50 shadow-lg shadow-gray-900/5">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2.5">
                    <FiMapPin className="inline w-4 h-4 mr-1.5" />
                    Country
                  </label>
                  <select
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2.5">
                  <FiAward className="inline w-4 h-4 mr-1.5" />
                  Tutor Type
                </label>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                    <FiGlobe className="inline w-4 h-4 mr-1.5" />
                    Languages I Teach
                  </label>
                  <button
                    type="button"
                ...
                <div className="space-y-3">
                  {teachingProfile.teaches.map((lang, idx) => (
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {teachingProfile.interests.map((interest, idx) => (
                    <span
                      key={idx}
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm rounded-lg border border-gray-200 dark:border-gray-700"
                    >
                      {interest}
                      <button
                        type="button"
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-4 focus:ring-brand-500/20 focus:border-brand-500 transition-all text-sm"
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
                        e.preventDefault();
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm font-semibold text-brand-600 bg-brand-50 rounded-xl hover:bg-brand-100 transition-colors"
                  >
                    Add
                  </button>
                </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                    <FiBook className="inline w-4 h-4 mr-1.5" />
                    Education
                  </label>
                  <button
                    type="button"
              ...
              <div>
                ...
                <div className="flex items-start gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      Record a 2-3 minute video introducing yourself. Show your personality and teaching style!
                    </p>
                  </div>
                </div>
                ...
                {videoPreviewUrl ? (
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        type="button"
                        onClick={() => setTeachingProfile({ ...teachingProfile, videoFile: null, videoUrl: "" })}
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (file) {
                      setTeachingProfile({ ...teachingProfile, videoFile: file });
                    }
                  }}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setTeachingProfile({ ...teachingProfile, teachingExperience: e.target.value })}
                  placeholder="Years of experience, age groups taught, teaching environments..."
                  rows={4}
                  className="w-full px-4 py-3 bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-4 focus:ring-brand-500/20 focus:border-brand-500 transition-all resize-y font-medium"
                />
                <p className="text-xs text-gray-500 mt-2">Describe your teaching background and experience</p>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setTeachingProfile({ ...teachingProfile, teachingStyle: e.target.value })}
                  placeholder="Describe your teaching methodology and approach..."
                  rows={4}
                  className="w-full px-4 py-3 bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-4 focus:ring-brand-500/20 focus:border-brand-500 transition-all resize-y font-medium"
                />
                <p className="text-xs text-gray-500 mt-2">Help students understand what to expect from your lessons</p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-3">Select all areas you're comfortable teaching:</p>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                  {specialtyOptions.map((specialty) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={teachingProfile.specialties.includes(specialty)}
                        onChange={(e) => {
                          if (e.target.checked) {
                            setTeachingProfile({
                              ...teachingProfile,
                              specialties: [...teachingProfile.specialties, specialty]
                            });
                          } else {
                            setTeachingProfile({
                              ...teachingProfile,
                              specialties: teachingProfile.specialties.filter(s => s !== specialty)
                            });
                          }
                        }}
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => setTeachingProfile({ ...teachingProfile, hourlyRate: parseInt(e.target.value) || 15 })}
                ...
                <p className="text-xs text-gray-500 mt-2">Recommended: $15-25/hour for new tutors</p>
              </div>
