  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 px-6 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
        ...
        {/* Needs attention */}
        <div className="group relative bg-gradient-to-br from-white via-gray-50/30 to-orange-50/10 rounded-2xl p-6 border border-gray-200/40 hover:border-orange-300/60 hover:shadow-xl hover:shadow-orange-500/10 hover:-translate-y-1 transition-all duration-300">
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center justify-between mb-1">
              <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">
                Needs Attention
              </span>
              <div className="p-1.5 bg-gradient-to-br from-orange-500/10 to-amber-600/5 rounded-lg opacity-60 group-hover:opacity-100 transition-opacity">
                <FiEdit3 className="w-3 h-3 text-orange-600" />
              </div>
            </div>
            <span className="text-3xl font-bold bg-gradient-to-br from-orange-600 via-orange-500 to-amber-600 bg-clip-text text-transparent">
              {stats.attention}
            </span>
          </div>
          <div className="absolute inset-0 bg-gradient-to-br from-orange-500/0 via-orange-500/0 to-orange-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        </div>

        {/* Completed this week */}
        <div className="group relative bg-gradient-to-br from-white via-gray-50/30 to-green-50/10 rounded-2xl p-6 border border-gray-200/40 hover:border-green-300/60 hover:shadow-xl hover:shadow-green-500/10 hover:-translate-y-1 transition-all duration-300">
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center justify-between mb-1">
              <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">
                Completed
              </span>
              <div className="p-1.5 bg-gradient-to-br from-green-500/10 to-emerald-600/5 rounded-lg opacity-60 group-hover:opacity-100 transition-opacity">
                <FiCheckCircle className="w-3 h-3 text-green-600" />
              </div>
            </div>
            <span className="text-3xl font-bold bg-gradient-to-br from-green-600 via-green-500 to-emerald-600 bg-clip-text text-transparent">
              {stats.completedThisWeek}
            </span>
          </div>
          <div className="absolute inset-0 bg-gradient-to-br from-green-500/0 via-green-500/0 to-green-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        </div>
      </div>
          ...
          <button
            ...
            className={clsx(
              ...
              filter === item.value
                ...
                : "bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 hover:border-brand-300"
            )}
          >
            {item.label}
            <span
