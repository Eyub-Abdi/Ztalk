...
function UpcomingLessonCard({ lesson }: { lesson: typeof mockUpcomingLessons[0] }) {
  const now = new Date();
...
function TutorCard({ tutor }: { tutor: typeof mockRecentTutors[0] }) {
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-5 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
      ...
      <Link
        to={`/student-dashboard/find-tutors`}
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <QuickAction
            icon={FiBookOpen}
            label="My Lessons"
            to="/student-dashboard/my-lessons"
            color="blue"
          />
          <QuickAction
            icon={FiStar}
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 mb-3">
              You've completed 3 lessons this week. Try to maintain your learning
              streak by booking your next lesson today.
            </p>
            <Link
              to="/student-dashboard/find-tutors"
