  ...
  return (
    <header className="sticky top-0 z-[1000] bg-white/95 backdrop-blur-md border-b border-gray-200/60 px-4 md:px-8 py-5 shadow-sm">
      <div className="flex items-center justify-between max-w-[2000px] mx-auto">
        {/* Left side - Menu button (mobile) + Sidebar toggle (when hidden) + title */}
        <div className="flex items-center gap-4">
          ...
          {!sidebarVisible && (
            <button
              ...
              className="hidden lg:block p-2.5 rounded-xl hover:bg-gray-100 transition-colors border border-gray-200"
        ...
        <main className="flex-1 px-6 lg:px-10 py-2 lg:py-3 min-h-[calc(100vh-89px)] transition-all duration-300 ease-in-out">
          ...
          {!isMobile && !sidebarVisible && (
            <button
              ...
              className="fixed top-24 left-4 z-40 p-3 bg-white border border-gray-200 rounded-xl shadow-lg hover:shadow-xl hover:bg-gray-50 transition-all duration-200"
              aria-label="Show sidebar"
            >
              <FiSidebar className="w-5 h-5 text-gray-700" />
            </button>
