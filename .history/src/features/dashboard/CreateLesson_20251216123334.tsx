...
export default function CreateLesson() {
  ...
  const handleSubmit = useCallback(
    ...
    [createLesson, description, durationMinutes, format, navigate, price, resetForm, title, toast]
  );
      ...
      <div className="space-y-5 max-w-5xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button type="button" onClick={resetForm} className="btn btn-outline text-sm">
              Reset
            </button>
            <button
              type="submit"
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="card p-5">
              <div className="space-y-4">
                <div>
                  <label htmlFor="lesson-title" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
                ...
                <div>
                  <label htmlFor="lesson-description" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
                    Description
                  </label>
                  <textarea
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            {isActive && (
                              <span className="text-xs font-medium text-brand-500">✓</span>
                            )}
                          </div>
