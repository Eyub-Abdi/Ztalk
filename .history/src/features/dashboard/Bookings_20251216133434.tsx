  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 px-6 py-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-white via-gray-50/30 to-brand-50/20 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-5 border border-gray-200/60 dark:border-gray-700/50 shadow-lg shadow-brand-500/5 min-w-[320px] backdrop-blur-sm">
          <p className="text-xs text-gray-500 dark:text-gray-400 font-semibold uppercase tracking-wider mb-2">Next lesson</p>
          <p className="text-base font-bold text-gray-900 dark:text-white">
            {nextLessonText}
          </p>
          <p className="text-sm text-brand-600 dark:text-brand-400 font-medium mt-1">{nextLessonRelative}</p>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-gradient-to-br from-white via-gray-50/50 to-brand-50/10 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-2xl shadow-gray-900/20 border border-gray-200/50 dark:border-gray-700/50 max-w-lg w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200/60 dark:border-gray-700/60 bg-gray-50/50 dark:bg-gray-800/50 rounded-b-2xl">
              <button onClick={handleCloseModal} className="px-5 py-2.5 rounded-xl font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all">
                Cancel
              </button>
              <button
