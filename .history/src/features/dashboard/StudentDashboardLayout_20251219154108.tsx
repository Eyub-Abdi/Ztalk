        ...
        <main className="flex-1 px-6 lg:px-10 py-2 lg:py-3 min-h-[calc(100vh-89px)] transition-all duration-300 ease-in-out">
          ...
          {!isMobile && !sidebarVisible && (
            <button
              ...
              className="fixed top-24 left-4 z-50 p-2 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg hover:bg-gray-50 transition-all duration-200"
