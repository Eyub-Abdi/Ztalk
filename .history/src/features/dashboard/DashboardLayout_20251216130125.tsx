        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Welcome back, <span className="font-medium text-gray-700">{displayUser?.first_name}</span>
            </p>
          </div>
        </div>
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-full bg-gradient-to-br from-brand-500 to-brand-600 flex items-center justify-center text-white font-bold text-lg shadow-md">
            {displayUser.first_name.charAt(0)}
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Desktop Sidebar */}
        {!isMobile && (
          <aside className="w-[300px] bg-gray-50 sticky top-0 h-screen flex-shrink-0">
            <div className="h-full p-6 overflow-y-auto scrollbar-hide" style={{ maxHeight: 'calc(100vh - 89px)', marginTop: '89px' }}>
              <SidebarContent />
            </div>
          </aside>
        )}
        ...
        {/* Main Content */}
        <main className="flex-1 p-6 lg:p-10 pt-6 lg:pt-10 overflow-y-auto">
          <Outlet />
        </main>
      </div>
    </div>
