        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="card p-6">
            ...
            <div>
              ...
              {form.country && (
                <div className="mb-4 p-4 bg-gradient-to-r from-brand-50 to-indigo-50 rounded-2xl border-2 border-brand-200 shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mt-0.5">
                        {countries.find((c) => c.code === form.country)?.region}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2 mb-4">
                {countries.map((country) => (
                  <button
                    ...
                    className={clsx(
                      "relative group aspect-square rounded-xl transition-all duration-200 flex items-center justify-center text-4xl",
                      form.country === country.code
                        ? "bg-gradient-to-br from-brand-500 to-indigo-600 shadow-lg shadow-brand-200 scale-105 ring-4 ring-brand-200"
                        : "bg-gradient-to-br from-gray-50 to-gray-100 hover:from-brand-50 hover:to-indigo-50 hover:shadow-md hover:scale-105 border border-gray-200 hover:border-brand-300"
                    )}
                  >
                    <span className={clsx(
                      "transform transition-transform duration-200",
                      form.country === country.code ? "scale-110" : "group-hover:scale-110"
                    )}>
                      {country.flag}
                    </span>
