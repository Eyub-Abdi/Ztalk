  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-xl max-h-[90vh] overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-8 py-6 border-b border-gray-100 dark:border-gray-700">
          ...
          <button
            type="button"
            onClick={onClose}
            className="p-2 -mr-2 rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
          >
        ...
        <div className="px-8 py-6 space-y-6 max-h-[60vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <div ref={fromRef} className="relative">
                <button
                  ...
                  className={clsx(
                    "w-full flex items-center justify-between px-0 py-2.5 bg-transparent border-b text-left transition-all",
                    fromDropdownOpen
                      ? "border-brand-500"
                ...
                {fromDropdownOpen && (
                  <div className="absolute z-50 mt-2 w-full max-h-48 overflow-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg">
            ...
            <div>
              ...
              <div ref={toRef} className="relative">
                ...
                >
                  <span
                    className={
                      toYear ? "text-gray-900 dark:text-white font-medium" : "text-gray-400"
                    }
                  >
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <input
                ...
                className="w-full px-0 py-2.5 bg-transparent border-b border-gray-200 dark:border-gray-600 focus:border-brand-500 focus:outline-none transition-all placeholder:text-gray-400"
                placeholder=""
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-0 py-2.5 bg-transparent border-b border-gray-200 dark:border-gray-600 focus:border-brand-500 focus:outline-none transition-all resize-none placeholder:text-gray-400"
        ...
        {/* Footer */}
        <div className="px-8 py-6 border-t border-gray-100 dark:border-gray-700 flex justify-end">
          <button
            type="button"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-5">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {data.educationEntries.length > 0 && (
                    <p className="text-gray-600 dark:text-gray-400">
                      {data.educationEntries.length} education{" "}
                      {data.educationEntries.length === 1 ? "entry" : "entries"}{" "}
                      added
                    </p>
                  )}
                </div>
