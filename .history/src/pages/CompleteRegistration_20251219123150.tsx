                  ...
                  {form.password && (
                    <div className="mt-3 p-3 bg-gray-50 rounded-lg space-y-1.5">
                      ...
                      <div className="space-y-1">
                        ...
                        />
                        <PasswordRequirement 
                          met={!/(.)\\1{2,}/.test(form.password)}
                          text="No repeated characters"
                        />
                        <PasswordRequirement 
                          met={!/(012|123|234|345|456|567|678|789|890)/.test(form.password)}
                          text="No sequential numbers"
                        />
                        <PasswordRequirement 
                          met={!/(abc|bcd|cde|def|efg|fgh|ghi|hij|ijk|jkl|klm|lmn|mno|nop|opq|pqr|qrs|rst|stu|tuv|uvw|vwx|wxy|xyz)/i.test(form.password)}
                          text="No sequential letters"
                        />
                        <PasswordRequirement 
                          met={!([form.username, form.first_name, form.last_name].filter(info => info && info.length > 2).some(info => form.password.toLowerCase().includes(info.toLowerCase())))}
