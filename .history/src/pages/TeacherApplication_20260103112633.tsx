...
export default function TeacherApplication() {
  ...
  const submitApplication = async () => {
    ...
    try {
      ...
      const convertFileToBase64Object = async (file: File) => {
      ...
      const profilePictureBase64 = data.profilePhoto
        ? await convertFileToBase64Object(data.profilePhoto)
        : null;

      const introductionVideoBase64 = data.videoFile
      ...
      const certificatesWithAttachments = await Promise.all(
        data.certifications.map(async (cert) => {
          ...
          if (cert.attachment) {
            certData.attachment = await convertFileToBase64Object(cert.attachment);
          }
