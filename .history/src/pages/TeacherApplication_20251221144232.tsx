...
const fetchAllowedCountries = async () => {
  try {
    console.log("Fetching allowed countries...");
    const response = await http("/api/teachers/allowed-countries/");
    console.log("API Response:", response);
    
    if (response?.success && response?.data?.allowed_countries) {
      console.log("Allowed countries:", response.data.allowed_countries);
