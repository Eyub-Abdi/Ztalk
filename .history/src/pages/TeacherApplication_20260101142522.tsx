...
export default function TeacherApplication() {
  ...
  // Languages for "Languages Taught" dropdown come from the
  // same availability API used for availability checks. If that
  // data is missing, fall back to the existing languageOptions.
  const teachableLanguageOptions =
    teachableLanguages && teachableLanguages.length > 0
      ? teachableLanguages.map((l) => ({ value: l.name, label: l.name }))
      : languageOptions;
