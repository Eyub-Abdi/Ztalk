...
export default function TeacherApplication() {
  ...
  // Languages for "Languages Taught" dropdown come only from the
  // availability API (useTeachableLanguages). We do not mix this with
  // native language options to keep responsibilities separate.
  const teachableLanguageOptions = (teachableLanguages || []).map((l) => ({
    value: l.name,
    label: l.name,
    code: l.code,
    flagImage: l.flagImage ?? undefined,
  }));
  ...
  // Language renderer for "Languages Taught" that uses only
  // availability API data (code/flagImage) carried through
  // teachableLanguageOptions.
