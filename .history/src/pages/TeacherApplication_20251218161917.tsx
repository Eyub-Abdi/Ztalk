              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-5 border-2 border-brand-200 dark:border-brand-800">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white">
                      Language to Teach <span className="text-red-500">*</span>
                    </h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Select the language you want to teach on Ztalk
                    </p>
                  </div>
                </div>
                ...
                {isLanguagesLoading ? (
                  <div className="flex items-center justify-center py-4">
                    <Spinner size="sm" />
                    <span className="ml-2 text-gray-500">Loading available languages...</span>
                  </div>
                ) : (
                  <>
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                      {teachableLanguages?.map((lang) => (
                        <label
                          key={lang.name}
                          className={`relative flex flex-col items-center p-4 rounded-xl cursor-pointer transition-all border-2 ${
                            !lang.available
                              ...
                              : data.languageTaught === lang.name
                              ? "bg-brand-50 dark:bg-brand-900/20 border-brand-500"
                              : "bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-600 hover:border-brand-300"
                          }`}
                        >
                          <input
                            type="radio"
                            name="languageTaught"
                            value={lang.name}
                            checked={data.languageTaught === lang.name}
                            onChange={(e) => {
                              if (lang.available) {
                                updateData("languageTaught", e.target.value);
                              }
                            }}
                          ...
                          {lang.available ? (
                            <span className="text-xs text-green-600 dark:text-green-400 mt-1">
                              {lang.spotsRemaining} spots left
                            </span>
                          ) : (
                            <span className="text-xs text-red-500 mt-1">Full</span>
                          )}
                          {data.languageTaught === lang.name && lang.available && (
                    ...
                    {data.languageTaught && languageAvailability && (
                      <div
                      ...
                      >
                        ...
                        <p className="text-sm">{languageAvailability.message}</p>
                      </div>
                    )}
                  </>
                )}
