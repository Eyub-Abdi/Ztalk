    ...
    switch (step) {
      ...
      case 4:
        ...
        if (!data.introText || data.introText.trim().length < 100)
          newErrors.introText = "Please write an introduction (minimum 100 characters)";
        break;
      case 5:
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="space-y-4">
                <textarea
                  ...
                  onChange={(e) => updateData("introText", e.target.value.slice(0, 1000))}
                  ...
                  <div className="flex items-center gap-2">
                    {data.introText && data.introText.trim().length >= 100 ? (
                      ...
                      <div className="text-yellow-600 dark:text-yellow-400">
                        {100 - data.introText.trim().length} more characters needed
                      </div>
                    ) : null}
                  </div>
