    ...
    <div className="max-w-2xl mx-auto px-4 py-16">
      <div className="space-y-8 text-center">
        ...
        <div className="flex items-start gap-3 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg text-left">
          ...
          <div>
            ...
            <p className="text-sm text-green-700 dark:text-green-300">
              Our team will carefully review your application and get back to you
        ...
        <div className="text-left">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-2">
              ...
              <span className="text-gray-700 dark:text-gray-300">
                <strong>Interview process</strong> - If selected, we&apos;ll contact
            ...
            <li className="flex items-start gap-2">
              ...
              <span className="text-gray-700 dark:text-gray-300">
                <strong>Start teaching</strong> - Once approved, you can set up your
        ...
        <div className="flex items-start gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg text-left">
          ...
          <div>
            <p className="font-semibold text-blue-800 dark:text-blue-200">Questions?</p>
            <p className="text-sm text-blue-700 dark:text-blue-300">
              If you have any questions about your application or the process, feel
              free to contact us at teachers@ztalk.com
            </p>
          </div>
        </div>
