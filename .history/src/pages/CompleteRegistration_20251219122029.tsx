                ...
                <div className="relative">
                  {form.country && (
                    <div className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center gap-2 pointer-events-none">
                      <img
                        src={countries.find((c) => c.code === form.country)?.flagUrl}
                        alt=""
                        className="w-5 h-4 rounded object-cover"
                      />
                      <span className="text-sm text-gray-600">
                        {countries.find((c) => c.code === form.country)?.callingCode || "+1"}
                      </span>
                    </div>
                  )}
                  <input
                    ...
                    onChange={handleChange}
                    placeholder={form.country ? "123 456 7890" : "+1 (555) 123-4567"}
                    className={clsx(
                      "input",
                      form.country && "pl-24",
