...
function DatePicker({
  ...
  const [selectedMonth, setSelectedMonth] = useState<number | null>(parsed ? parsed.getMonth() : null);
  const [selectedYear, setSelectedYear] = useState<number | null>(parsed ? parsed.getFullYear() : null);
  const [viewMonth, setViewMonth] = useState(parsed ? parsed.getMonth() : new Date().getMonth());
  const [viewYear, setViewYear] = useState(parsed ? parsed.getFullYear() : currentYear - 25);
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3 py-1.5 bg-gray-100 dark:bg-gray-700 rounded-lg text-sm font-semibold text-gray-900 dark:text-white border-0 focus:ring-2 focus:ring-brand-500"
              >
