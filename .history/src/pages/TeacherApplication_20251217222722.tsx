          ...
          <div className="space-y-8">
                    ...
                    {["male", "female", "other"].map((g) => (
                      ...
                      >
                        ...
                        <span className={clsx(
                          ...
                          data.gender === g ? "text-brand-600 dark:text-brand-400" : "text-gray-700 dark:text-gray-300"
                        )}>{g}</span>
                      </label>
                    ))}
                  </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 space-y-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Language Skills</h3>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-100 dark:border-gray-700">
                ...
                {data.otherLanguages.length === 0 ? (
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-8 text-center border-2 border-dashed border-gray-200 dark:border-gray-600">
                    ...
                    <p className="text-sm text-gray-400 mt-1">Click "Add" to add more languages</p>
                  </div>
                ) : (
                  <div className="space-y-3">
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="text-center pb-4 border-b border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-500 dark:text-gray-400 mt-1">Share your background and expertise</p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 space-y-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Upload teaching certificates (optional)</p>
                </div>
              </div>
              ...
              <div className="border-2 border-dashed border-gray-200 dark:border-gray-600 rounded-xl p-6 bg-white dark:bg-gray-800 text-center">
                ...
                <label htmlFor="certifications" className="cursor-pointer">
                  ...
                  <p className="font-semibold text-gray-800 dark:text-gray-200">Upload Certificates</p>
            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 space-y-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Teaching Specialties</h3>
                  <p className="text-sm text-gray-500">Select all areas you're comfortable teaching</p>
                </div>
              </div>
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="text-center pb-4 border-b border-gray-100 dark:border-gray-700">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Video Introduction</h2>
              <p className="text-gray-500 dark:text-gray-400 mt-1">Record a short video to introduce yourself</p>
            </div>
              ...
              <div className={clsx(
                ...
                {data.videoFile ? (
                  <>
                    ...
                    <p className="font-semibold text-gray-800 dark:text-gray-200 mb-1">Video Uploaded!</p>
                    <p className="text-sm text-green-600 dark:text-green-400 truncate max-w-[300px] mx-auto">{data.videoFile.name}</p>
                  </>
                ) : (
                  <>
                    <div className="w-16 h-16 mx-auto rounded-2xl bg-gray-100 dark:bg-gray-700 flex items-center justify-center mb-4">
                      <FaPlay className="w-6 h-6 text-gray-400 ml-1" />
                    </div>
                    <p className="font-semibold text-gray-800 dark:text-gray-200 mb-1">Upload Your Video</p>
                    <p className="text-sm text-gray-500 mb-4">Max 100MB. Formats: MP4, MOV, AVI</p>
                  </>
                )}
                <input
                  id="intro-video"
                ...
                <label
                  htmlFor="intro-video"
                  className={clsx(
                    "inline-flex items-center gap-2 mt-2 px-6 py-3 rounded-xl font-semibold cursor-pointer transition-all",
                    data.videoFile 
                      ? "bg-white dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-gray-300" 
                      : "bg-gradient-to-r from-brand-500 to-brand-600 text-white shadow-lg shadow-brand-500/30 hover:shadow-xl"
                  )}
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="text-center pb-4 border-b border-gray-100 dark:border-gray-700">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Availability & Rate</h2>
              <p className="text-gray-500 dark:text-gray-400 mt-1">Set your schedule and pricing</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-2xl font-bold text-gray-800 dark:text-gray-200">$</span>
                  <input
                    id="hourly-rate"
                    type="number"
                    min="10"
            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 space-y-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white">Weekly Availability</h3>
                  <p className="text-sm text-gray-500">Select time slots when you're available to teach</p>
                </div>
              </div>
              ...
              {data.availability.length > 0 && (
                <div className="flex items-center gap-2 text-sm text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-900/20 px-4 py-3 rounded-xl">
                  ...
                  <span className="font-medium">{data.availability.length} time slots selected</span>
                </div>
              )}
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="text-center pb-4 border-b border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-500 dark:text-gray-400 mt-1">Please verify your information before submitting</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-5">
                ...
                <div className="space-y-2 text-sm">
                  <p className="text-gray-600 dark:text-gray-400">
                    <span className="font-medium text-gray-800 dark:text-gray-200">{data.firstName} {data.lastName}</span>
                  </p>
                  <p className="text-gray-600 dark:text-gray-400">{data.email}</p>
                  <p className="text-gray-600 dark:text-gray-400">{data.from} → {data.livingIn}</p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-5">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <p className="font-semibold text-gray-900 dark:text-white">Rate & Schedule</p>
                </div>
                <div className="space-y-2 text-sm">
                  <p className="text-gray-600 dark:text-gray-400">
                    <span className="text-2xl font-bold text-green-600">${data.hourlyRate}</span>/hour
                  </p>
                  <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <p className="font-semibold text-gray-900 dark:text-white">Teaching Specialties</p>
              </div>
            ...
            <label className={clsx(
              ...
              />
              <span className="text-sm text-gray-700 dark:text-gray-300">
                I agree to the <span className="text-brand-600 dark:text-brand-400 font-medium hover:underline">Terms of Service</span> and <span className="text-brand-600 dark:text-brand-400 font-medium hover:underline">Privacy Policy</span> for teachers on Ztalk
              </span>
            </label>
            ...
            <div className="flex items-start gap-4 p-5 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                  After submission, our team will review your application within 2-3 business days. You'll receive an email notification with the result.
                </p>
              </div>
            </div>
          </div>
