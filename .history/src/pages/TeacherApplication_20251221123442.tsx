...
function TeachingExperienceForm({
  ...
  const handleSubmit = () => {
    if (!formData.fromYear || !formData.toYear || !formData.position || !formData.company) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-600">
      ...
      <button
        ...
        disabled={!formData.fromYear || !formData.toYear || !formData.position || !formData.company}
...
function EducationForm({
  ...
  const handleSubmit = () => {
    if (!formData.fromYear || !formData.toYear || !formData.institution || !formData.major || !formData.degree) {
      return; // Basic validation
    }
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-600">
      ...
      <button
        type="button"
        onClick={handleSubmit}
        disabled={!formData.fromYear || !formData.toYear || !formData.institution || !formData.major || !formData.degree}
        className="w-full px-4 py-2.5 bg-brand-500 hover:bg-brand-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold rounded-xl transition-all"
      >
        Add Education
      </button>
                  ...
                  {data.teachingExperienceEntries.map((entry, index) => (
                    ...
                    >
                      <div className="flex items-start justify-between">
                        ...
                        <button
                          type="button"
                          onClick={() => removeTeachingExperienceEntry(entry.id)}
