        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-100 text-brand-700 rounded-full text-sm font-semibold">
                <FiZap className="w-4 h-4" />
                Premium Plan
              </div>
              
              <div className="space-y-2">
                <h3 className="text-3xl font-black text-gray-900">Ztalk Plus</h3>
                <div className="flex items-baseline justify-center gap-2">
                  <span className="text-6xl font-black bg-gradient-to-r from-brand-600 to-indigo-600 bg-clip-text text-transparent">$19</span>
            ...
            <div className="space-y-4">
              <h4 className="text-lg font-bold text-gray-900 mb-6">Everything included:</h4>
            ...
            {/* CTA Button */}
            <div className="space-y-4">
              <button className="w-full max-w-sm mx-auto py-4 px-8 text-lg font-bold text-white bg-gradient-to-r from-brand-500 to-brand-600 rounded-full hover:-translate-y-1 transform transition-all duration-300 shadow-lg hover:shadow-xl">
                Start Plus Today
              </button>
