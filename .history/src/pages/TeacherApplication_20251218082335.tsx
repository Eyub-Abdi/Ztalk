          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 space-y-4">
              ...
              <div className="rounded-xl overflow-hidden bg-black aspect-video relative group">
                <video
                  controls
                  poster="/images/example-video-poster.jpg"
                  className="w-full h-full object-cover"
                >
                  <source src="/videos/tutor-intro-example.mp4" type="video/mp4" />
                  <track kind="captions" />
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                <span>This example shows a clear, friendly introduction that students love</span>
              </div>
            </div>
              ...
              >
                {data.videoFile ? (
                  <>
                    ...
                    <p className="text-sm text-green-600 dark:text-green-400 truncate max-w-[300px] mx-auto">
                      {data.videoFile.name}
                    </p>
                  </>
                ) : (
