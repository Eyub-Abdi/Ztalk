      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={clsx("input pr-10", errors.password_confirm && "input-error")}
                    />
                    <button
                      type="button"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  value={form.country}
                  onChange={handleChange}
                  className={clsx("input cursor-pointer", errors.country && "input-error")}
                >
          ...
          <p className="text-center text-sm text-gray-500 leading-relaxed">
            ...
            <Link to="/terms" className="text-brand-600 hover:text-brand-700 font-medium hover:underline">
              Terms of Service
            </Link>{" "}
            and{" "}
            <Link to="/privacy" className="text-brand-600 hover:text-brand-700 font-medium hover:underline">
              Privacy Policy
            </Link>
          </p>
        </form>
