            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Write a short bio that highlights your teaching approach and personality
                  </p>
                </div>
              </div>

              <label htmlFor="teacher-bio" className="sr-only">Teacher bio</label>
              <textarea
                id="teacher-bio"
                ...
                rows={4}
                maxLength={500}
                className={"w-full px-4 py-2.5 bg-white dark:bg-gray-800 border rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent outline-none transition-all resize-y " +
              ...
              <div className="flex items-center justify-between">
                <p className={(data.teacherBio && data.teacherBio.trim().length < 50) ? "text-xs text-red-500" : "text-xs text-green-600"}>
                  {data.teacherBio.trim().length < 50
                    ? `${Math.max(0, 50 - data.teacherBio.trim().length)} more characters needed`
                    : "✓ Bio looks good!"}
                </p>
                <p className="text-xs text-gray-400">{data.teacherBio.length}/500</p>
              </div>
              {errors.teacherBio && (
