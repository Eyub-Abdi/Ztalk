          ...
          <div className="flex-1 max-w-md mx-auto lg:mx-0">
            {showValidation && newPassword ? (
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg border border-gray-100 p-8">
                <div className="mb-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Security Requirements</h3>
                  <p className="text-sm text-gray-500">Your password must meet these criteria</p>
                </div>
                  ...
                  {[
                    ...
                    <div key={key} className="flex items-center gap-3">
                      <div className={`w-5 h-5 rounded-full flex items-center justify-center transition-all duration-200 ${
                        ...
                        <FiCheck className={`w-3 h-3 transition-all duration-200 ${
                          passwordValidation[key as keyof PasswordValidation] 
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-1.5">
                    <div 
                      className="bg-gradient-to-r from-emerald-400 to-emerald-600 h-1.5 rounded-full transition-all duration-500 ease-out"
                      style={{ 
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-3xl shadow-lg border border-gray-100 p-8">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500">
                    Start typing to see security requirements
                  </p>
                </div>
              </div>
            )}
