              ...
              <div className="grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-8 gap-3 max-h-64 overflow-y-auto p-2">
                {filteredCountries.map((country) => (
                  <button
                    ...
                    title={country.name}
                    className={clsx(
                      "relative flex flex-col items-center justify-center p-3 rounded-lg transition-all border-2",
                  ...
                  >
                    {country.flagCode ? (
                      <img
                        src={`https://flagcdn.com/48x36/${country.flagCode}.png`}
                        alt={country.name}
                        className="w-12 h-9 rounded object-cover mb-1"
                      />
                    ) : (
