                ...
                {data.otherLanguages.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {data.otherLanguages.map((lang, index) => {
                      const isTeachableLevel = lang.level === "native" || lang.level === "c2";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-5">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {data.otherLanguages.filter(l => l.level === "native" || l.level === "c2").length > 0 && (
                      ...
                      {data.otherLanguages
                        ...
                        .map((l, i) => (
                          <span key={i} className="font-medium text-brand-600 dark:text-brand-400">
                            {l.language}{i < data.otherLanguages.filter(x => x.level === "native" || x.level === "c2").length - 1 ? ", " : ""}
                          </span>
                        ))
                      }
                    </div>
