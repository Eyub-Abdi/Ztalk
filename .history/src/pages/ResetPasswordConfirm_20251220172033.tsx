        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 lg:p-10">
              ...
              <form onSubmit={onSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all text-base"
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-semibold py-4 px-6 rounded-2xl transition-all duration-200 transform hover:scale-[1.02] disabled:hover:scale-100 disabled:cursor-not-allowed flex items-center justify-center gap-3 text-base"
                >
                  {loading ? (
                    <>
          ...
          <div className="order-1 lg:order-2 lg:sticky lg:top-8">
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Security Requirements</h3>
                <p className="text-gray-600">Your password must meet these criteria</p>
              </div>
