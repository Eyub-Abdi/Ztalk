                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-100 dark:border-blue-800">
                    ...
                    <ul className="text-xs text-gray-600 dark:text-gray-400 space-y-1.5">
                      <li className="font-semibold text-blue-700 dark:text-blue-300">Technical:</li>
                      <li>• Minimum 250×250 pixels</li>
                      <li>• JPG, PNG, or BMP format</li>
                      <li>• Maximum 2MB</li>
                      <li className="font-semibold text-blue-700 dark:text-blue-300 mt-2">Professional Standards:</li>
