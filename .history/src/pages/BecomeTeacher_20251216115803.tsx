...
const benefits = [
  {
    ...
    description: "Earn $15-25 per hour teaching Swahili to motivated students worldwide.",
  ...
  },
  {
    ...
    description: "Connect with students from around the world and share your culture.",
  ...
  },
  {
    ...
    description: "Help students build confidence and connections through language learning.",
    color: "text-red-500",
      ...
      <div className="relative overflow-hidden pt-16 md:pt-24 pb-20 md:pb-32 bg-gradient-to-br from-brand-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="container-main relative">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            >
              Share your passion for Swahili culture and language with students around the world.
              Set your own schedule, work from anywhere, and make a lasting impact.
            </motion.p>
                  ...
                  {[...Array(4)].map((_, i) => (
                    <div
                      ...
                      className={`w-8 h-8 rounded-full border-2 border-white dark:border-gray-800 ${
                        ["bg-brand-400", "bg-blue-400", "bg-green-400", "bg-purple-400"][i]
                      }`}
                    />
                  ))}
                </div>
        ...
        <div className="container-main">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <p className="text-3xl md:text-4xl font-bold text-brand-500">{stat.value}</p>
          ...
          <div className="space-y-12">
            <div className="text-center max-w-3xl mx-auto space-y-4">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                Join a community that values your expertise and supports your success
              </p>
            </div>
          ...
          >
            ...
            <div className="relative space-y-6">
              ...
              <p className="text-lg text-white/90 max-w-2xl mx-auto">
                Join hundreds of teachers who are already making a difference in students&apos;
                lives while earning competitive income on their own schedule.
              </p>
