    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          >
            <div className="relative p-8 bg-white rounded-3xl shadow-2xl border border-gray-100 hover:shadow-3xl transition-all duration-300">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <div className="px-6 py-2 bg-gradient-to-r from-brand-500 to-brand-600 text-white text-sm font-bold rounded-full shadow-lg">
              ...
              <div className="text-center mb-8 pt-4">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Ztalk Plus</h3>
                <div className="flex items-baseline justify-center gap-1 mb-2">
                  <span className="text-5xl font-black bg-gradient-to-r from-brand-600 to-indigo-600 bg-clip-text text-transparent">$19</span>
              ...
              <button className="w-full py-4 text-lg font-bold text-white bg-gradient-to-r from-brand-500 to-brand-600 rounded-xl hover:-translate-y-1 hover:shadow-lg transform transition-all duration-300 shadow-md">
                Start Plus Today
              </button>
