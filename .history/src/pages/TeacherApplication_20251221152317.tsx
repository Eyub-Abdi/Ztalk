...
export default function TeacherApplication() {
  ...
  const renderCountryOption = (opt: { value: string; label: string; code?: string; flagEmoji?: string; flagUrl?: string }) => {
  ...
  const renderSelectedCountry = (opt: { value: string; label: string; code?: string; flagEmoji?: string; flagUrl?: string }) => {
    // For allowed countries (with code and flag from API)
    if (opt.code && (opt.flagUrl || opt.flagEmoji)) {
      return (
        <div className="flex items-center gap-2">
