...
export default function JoinPlusPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative pt-20 pb-32 bg-gradient-to-br from-amber-50 to-orange-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          <div className="text-center space-y-8">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-full text-sm font-semibold"
            >
            ...
            >
              Get premium access to our best tutors, exclusive content, and personalized learning tools.
            </motion.p>
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <button className="px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-amber-500 to-orange-500 rounded-full hover:-translate-y-1 transform transition-all duration-300 shadow-lg flex items-center gap-3 mx-auto">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">
              Why Choose <span className="text-amber-600">Plus?</span>
            </h2>
      ...
      <div className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          >
            <div className="relative p-8 bg-white rounded-3xl shadow-xl border-2 border-amber-200">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <div className="px-6 py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-sm font-bold rounded-full">
                  Most Popular
                </div>
              </div>

              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Plus Monthly</h3>
              ...
              <button className="w-full py-4 text-lg font-bold text-white bg-gradient-to-r from-amber-500 to-orange-500 rounded-xl hover:-translate-y-1 transform transition-all duration-300 shadow-lg">
                Start Plus Today
              </button>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="px-8 py-4 text-lg font-bold text-amber-600 bg-white rounded-full hover:-translate-y-1 transform transition-all duration-300 shadow-lg flex items-center gap-3">
