...
function Dropdown({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute z-50 mt-2 w-full max-h-60 bg-white dark:bg-gray-800 border-2 border-gray-100 dark:border-gray-700 rounded-xl shadow-xl">
          {/* Search Input */}
          <div className="sticky top-0 p-3 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 rounded-t-xl">
            <input
              ref={searchInputRef}
              type="text"
              value={filterText}
              ...
              className="w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
              onKeyDown={(e) => {
                if (e.key === 'Escape') {
                  setOpen(false);
                  setFilterText("");
          ...
          <div className="max-h-48 overflow-auto">
            {filteredOptions.length === 0 ? (
              <div className="px-4 py-3 text-gray-500 dark:text-gray-400 text-sm">
                No countries found starting with "{filterText}"
              </div>
            ) : (
