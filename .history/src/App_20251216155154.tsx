      ...
      <header className="sticky top-0 z-[1000] bg-white/95 backdrop-blur-md border-b border-gray-100 px-4 md:px-6 py-3 shadow-sm">
        <div className="flex items-center gap-6">
          <RouterLink
            ...
            onClick={onClose}
          >
            <div className="w-9 h-9 bg-gradient-to-br from-brand-500 via-brand-600 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-brand-500/30 group-hover:shadow-xl group-hover:shadow-brand-500/40 group-hover:-translate-y-0.5 transition-all duration-200">
              <span className="text-white font-black text-lg">Z</span>
            </div>
            <span className="text-xl font-black bg-gradient-to-r from-gray-900 via-brand-600 to-indigo-600 bg-clip-text text-transparent">
              Ztalk
            </span>
          </RouterLink>
