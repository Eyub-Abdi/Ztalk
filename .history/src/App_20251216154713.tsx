...
function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="sticky top-0 z-[1000] bg-white border-b border-gray-200 px-4 md:px-6 py-3 shadow-sm">
        <div className="flex items-center gap-6">
          ...
          <div className="hidden md:flex items-center gap-4">
            {isAuthenticated ? (
              ...
              <>
                <button onClick={openLogin} className="text-sm font-medium text-gray-700 hover:text-brand-600 transition-colors">
                  Login
                </button>
                <button onClick={openSignup} className="text-sm font-medium text-gray-700 hover:text-brand-600 transition-colors">
                  Sign Up
                </button>
                <RouterLink
                  to="/become-teacher"
                  className="px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-brand-500 via-brand-600 to-indigo-600 rounded-full shadow-lg shadow-brand-500/30 hover:shadow-xl hover:shadow-brand-500/40 hover:-translate-y-0.5 transition-all duration-200"
                >
                  Become a Teacher
                </RouterLink>
              </>
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <RouterLink
                  to="/become-teacher"
                  onClick={onClose}
                  className="py-3 text-center text-sm font-semibold text-white bg-gradient-to-r from-brand-500 via-brand-600 to-indigo-600 rounded-full shadow-lg shadow-brand-500/30"
                >
                  Become a Teacher
                </RouterLink>
              </>
