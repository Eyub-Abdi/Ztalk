...
function StatCard({ label, value, icon }: StatProps) {
  return (
    ...
    >
      <div className="relative p-4 rounded-2xl bg-white/70 backdrop-blur-xl shadow-lg border border-white/20 overflow-hidden group">
        ...
        <div className="flex items-center justify-center mb-3 relative z-10">
          <motion.div
            className="p-2 rounded-xl bg-gradient-to-br from-brand-500 to-brand-600 text-white shadow-md shadow-brand-500/30 group-hover:shadow-brand-500/50"
            whileHover={{ 
              scale: 1.15, 
              rotate: [0, -8, 8, 0],
        ...
        >
          <h3 className="text-xl font-black text-gray-900 group-hover:text-brand-700 transition-colors duration-300 tracking-tight">
            {value}
          </h3>
        </motion.div>
