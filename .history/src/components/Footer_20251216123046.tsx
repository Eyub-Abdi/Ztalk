        ...
        <div className="space-y-12 md:space-y-16">
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-16 justify-between items-start">
            ...
            <div className="flex flex-col items-start gap-6 md:basis-[30%]">
              ...
              <form onSubmit={handleSubmit} className="w-full">
                <label htmlFor="newsletter-email" className="block text-xs uppercase tracking-wider text-gray-500 mb-2">
                  Stay in the loop
                </label>
          ...
          <div className="space-y-4 text-xs" id="legal">
            ...
            <div className="flex flex-wrap gap-4 text-gray-500">
              ...
              <a href="#cookies" className="hover:text-brand-500 transition-colors">
                Cookies
              </a>
              <a href="#contact" className="hover:text-brand-500 transition-colors">
                Contact
              </a>
            </div>
