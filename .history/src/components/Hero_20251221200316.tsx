...
function StatCard({ label, value, icon }: StatProps) {
  return (
    ...
    >
      <div className="relative p-6 rounded-3xl bg-white/70 backdrop-blur-xl shadow-xl border border-white/20 overflow-hidden group">
        ...
        <div className="flex items-center justify-center mb-4 relative z-10">
          <motion.div
            className="p-3 rounded-2xl bg-gradient-to-br from-brand-500 to-brand-600 text-white shadow-lg shadow-brand-500/30 group-hover:shadow-brand-500/50"
            whileHover={{ 
              scale: 1.2, 
              rotate: [0, -10, 10, 0],
        ...
        >
          <h3 className="text-3xl font-black text-gray-900 group-hover:text-brand-700 transition-colors duration-300 tracking-tight">
            {value}
          </h3>
        </motion.div>
        ...
        <div className="text-center relative z-10">
          <p className="text-sm font-semibold text-gray-600 group-hover:text-brand-600 transition-colors duration-300 tracking-wide uppercase">
            {label}
          </p>
        </div>

        {/* Bottom glow effect */}
        <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-1/2 h-4 bg-brand-500/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      </div>
    </MotionDiv>
  );
}
