          ...
          <div className="flex items-center">
            <div className="space-y-6">
              ...
              >
                ...
                <h1 className="text-[2rem] sm:text-[2.3rem] md:text-[3rem] lg:text-[3.3rem] font-extrabold leading-[1.1] tracking-tight text-gray-900 relative z-10" style={{ wordSpacing: '0.3em' }}>
                  <AnimatedText
