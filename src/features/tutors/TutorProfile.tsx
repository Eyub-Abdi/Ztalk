  ...
  lessons: [
    {
      ...
      title: "Trial Lesson",
      description:
        "Get to know each other and discuss your learning goals. I'll assess your current level and create a personalized learning plan.",
      duration: 30,
      price: 5.0,
      currency: "USD",
      isTrialLesson: true,
    },
    {
      ...
      description:
        "Perfect for complete beginners. Learn basic greetings, essential vocabulary, and simple conversations for travel and daily life.",
      duration: 60,
      price: 15.0,
      currency: "USD",
    },
    {
      ...
      description:
        "Improve your speaking skills through guided conversations about various topics. Great for intermediate learners.",
      duration: 60,
      price: 18.0,
      currency: "USD",
    },
    {
      ...
      description:
        "Practice English speaking in a relaxed, friendly environment. Focus on fluency, pronunciation, and natural expressions.",
      duration: 60,
      price: 12.0,
      currency: "USD",
    },
    {
      ...
      description:
        "Learn about Swahili culture, traditions, and get tips for traveling in East Africa. Combines language learning with cultural insights.",
      duration: 60,
      price: 20.0,
      currency: "USD",
    },
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
              <div className="flex gap-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-start gap-4 mt-4">
                    <span className="text-sm text-gray-500 pt-0.5 min-w-[60px]">
                      Teaches
                    </span>
              ...
              <div className="flex gap-3 mt-6 lg:hidden">
                ...
                >
                  <FiHeart
                    className={clsx("w-5 h-5", isFavorited && "fill-current")}
                  />
                </button>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        <span>
                          Living in {tutor.city}, {tutor.countryName} (
                          {tutor.localTime} {tutor.timezone})
                        </span>
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-sm text-gray-500">
                          Teacher since{" "}
                          {tutor.teacherSince.toLocaleDateString("en-US", {
                            month: "short",
                            day: "numeric",
                            year: "numeric",
                          })}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6 border-t border-gray-100">
                      <div className="text-center p-4 bg-gray-50 rounded-xl">
                        <p className="text-3xl font-bold text-gray-900">
                          {tutor.totalLessons.toLocaleString()}
                        </p>
